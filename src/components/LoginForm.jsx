    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-80 h-[468px] p-4 bg-white rounded-2xl shadow-[0px_0px_28px_0px_rgba(0,0,0,0.04)] inline-flex flex-col justify-start items-start gap-6">
        ...
        <button
          ...
          className="self-stretch h-12 px-6 py-4 bg-teal-700 rounded-lg outline outline-1 outline-offset-[-1px] outline-neutral-400 inline-flex justify-center items-center gap-2.5"
        >
