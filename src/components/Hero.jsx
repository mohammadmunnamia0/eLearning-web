        ...
        <section className="text-white p-4 md:p-6 lg:p-8 flex flex-col lg:flex-row justify-between gap-6">
          <div className="font-nav lg:pl-9 w-full lg:w-1/2">
            <div className="w-full">
              <h1 className="w-full text-white text-[28px] sm:text-[32px] md:text-[40px] lg:text-[50px] font-semibold break-words">
                আমাদের শিক্ষা কম্পিউটার ট্রেনিং সেন্টারে আপনাকে স্বাগতম
              </h1>

              <p className="w-full text-white text-[14px] sm:text-[16px] md:text-[18px] font-normal break-words mt-4">
            ...
            <div className="navbar-start mt-4 flex flex-wrap gap-2">
              <NavLink to="/course" className="w-full sm:w-auto">
                <div className="inline-flex items-center justify-center gap-2 px-4 md:px-6 py-3 bg-[#FF9900] rounded shadow-[0px_4px_7px_rgba(255,153,0,0.71)] overflow-hidden hover:bg-[#FF8800] transition-colors">
          ...
          <div className=" flex justify-center items-center">
            <img
              ...
              alt="Hero"
              className="w-full h-auto mt-6 lg:mt-0 rounded-lg shadow-lg max-w-[500px] mx-auto"
            />
          </div>
        </section>
        <section className="relative top-3 lg:top-10">
          <div className="flex flex-col sm:flex-row gap-4 px-4 md:px-6 lg:px-9 pb-6">
            <div className="w-full sm:w-auto inline-flex items-center justify-start gap-2 p-3 bg-white rounded-xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
